...
exports.restoreToSurfaceFromKey =
    exports.is括弧Token =
    exports.is助詞Token =
    exports.create読点Matcher =
    exports.createKeyFromKey =
    exports.concatJoishiTokens =
        void 0;
...
var createKeyFromKey = (token) => {
    ...
    // と	助詞	接続助詞	*	*
    return ""
        .concat(token.surface_form, ":")
        .concat(token.pos, ".")
        .concat(token.pos_detail_1, ".")
        .concat(token.pos_detail_2, ".")
        .concat(token.pos_detail_3);
};
// keyからsurfaceを取り出す
